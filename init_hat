...
local BytexConvert = (getgenv and getgenv()) or shared

local BytexConvert.HatID = 76734658816459
local BytexConvert.HatCFrame = CFrame.new(0, -1.2, -0.6) * CFrame.Angles(math.rad(-90), math.rad(180) , 0)

]]--

local BytexConvert = (getgenv and getgenv()) or shared

local BytexConvert_HatID = BytexConvert.HatID
local BytexConvert_HatCFrame = BytexConvert.HatCFrame
...
if not accessory then
    warn("Could not find accessory: " .. HAT_NAME)
    return
end
