...
function Library:create(options)
	...
	creditsTab:credit{Name = "2faint", Description = "Creator / Converter", Discord="tniaf"}
	creditsTab:credit{Name = "Gelatek", Description = "Reanimation", Discord="???"}
